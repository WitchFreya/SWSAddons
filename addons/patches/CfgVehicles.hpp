...
#define CLASSES_VEHICLES \
    ...
    "VES_D77HTCI",  \
    "VES_D77HTCIS", \
    "TCGM_f_underwear_soldier", \
    "TCGM_f_PantiesBlack_soldier",  \
    "TCGM_RollUp_B_MTP_Soldier_AR", \
    "TCGM_RollUp_B_TNA_Soldier_AR", \
    "TCGM_RollUp_B_WDL_Soldier_AR", \
    "TCGM_RollUp_B_MTP_Medic",  \
    "TCGM_RollUp_B_TNA_Medic",  \
    "TCGM_RollUp_B_WDL_Medic",  \
    "TCGM_RollUp_B_MTP_engineer",   \
    "TCGM_RollUp_B_TNA_engineer",   \
    "TCGM_RollUp_B_WDL_engineer",   \
    "TCGM_RollUp_B_MTP_soldier_exp",    \
    "TCGM_RollUp_B_TNA_soldier_exp",    \
    "TCGM_RollUp_B_WDL_soldier_exp",    \
    "TCGM_RollUp_B_MTP_Soldier_M",  \
    "TCGM_RollUp_B_TNA_Soldier_M",  \
    "TCGM_RollUp_B_WDL_Soldier_M",  \
    "TCGM_RollUp_B_MTP_officer",    \
    "TCGM_RollUp_B_TNA_officer",    \
    "TCGM_RollUp_B_WDL_officer",    \
    "TCGM_RollUp_B_MTP_soldier_repair", \
    "TCGM_RollUp_B_TNA_soldier_repair", \
    "TCGM_RollUp_B_WDL_soldier_repair", \
    "TCGM_RollUp_B_MTP_Soldier_LT", \
    "TCGM_Bra_B_MTP_Soldier_SL",    \
    "TCGM_Bra_B_TNA_Soldier_SL",    \
    "TCGM_Bra_B_WDL_Soldier_SL",    \
    "TCGM_Bra_B_MTP_soldier_TL",    \
    "TCGM_Bra_B_TNA_soldier_TL",    \
    "TCGM_Bra_B_WDL_soldier_TL",    \
    "TCGM_RollUp_B_MTP_soldier_UAV",    \
    "TCGM_RollUp_B_TNA_soldier_UAV",    \
    "TCGM_RollUp_B_WDL_soldier_UAV",    \
    "TCGM_Bra_I_Sage_Looter_SMG",   \
    "TCGM_Bra_I_M81_Looter_Pistol", \
    "TCGM_Bra_I_M81_Looter_Rifle",  \
    "TCGM_Bra_I_M81_Looter_Shotgun",    \
    "TCGM_Stealth_B_CTRG_Soldier_TL",   \
    "TCGM_Stealth_B_CTRG_Soldier_AR",   \
    "TCGM_Stealth_B_CTRG_Soldier_SC",   \
    "TCGM_Stealth_B_CTRG_Soldier_M",    \
    "TCGM_Stealth_B_CTRG_Soldier_Exp",  \
    "TCGM_Stealth_B_CTRG_Soldier_Medic",    \
    "TCGM_Stealth_B_CTRG_Soldier_JTAC", \
    "TCGM_Stealth_B_CTRG_Soldier_LAT2", \
    "TCGM_Stealth_B_CTRG_Soldier_LAT",  \
    "TCGM_F_B_Mini_Range",  \
    "TCGM_F_C_Mini_Journalist", \
    "TCGM_F_C_Mini_JournalistWar",  \
    "TCGM_F_C_Mini_Marshal",    \
    "TCGM_F_C_Mini_IDAP",   \
    "TCGM_F_C_Mini_Navy",   \
    "TCGM_F_C_Sport_1", \
    "TCGM_Survival_Bra_B_MTP_Soldier",  \
    "TCGM_Viper_O_AHex_Soldier",    \
    "TCGM_Viper_O_GHex_Soldier",    \
    "TCGM_Viper_O_UHex_Soldier",    \
    "TCGM_Viper_O_TL_Hex_Soldier",  \
    "TCGM_Viper_O_TL_GHex_Soldier", \
    "TCGM_Viper_O_TL_UHex_Soldier", \
    "TCGM_Viper_O_m_Hex_Soldier",   \
    "TCGM_Viper_O_m_GHex_Soldier",  \
    "TCGM_Viper_O_m_UHex_Soldier",  \
    "TCGM_Viper_O_Exp_Hex_Soldier", \
    "TCGM_Viper_O_Exp_GHex_Soldier",    \
    "TCGM_Viper_O_Exp_UHex_Soldier",    \
    "TCGM_Viper_O_Medic_Hex_Soldier",   \
    "TCGM_Viper_O_Medic_GHex_Soldier",  \
    "TCGM_Viper_O_Medic_UHex_Soldier",  \
    "TCGM_Viper_O_lat_Hex_Soldier", \
    "TCGM_Viper_O_lat_GHex_Soldier",    \
    "TCGM_Viper_O_lat_UHex_Soldier",    \
    "TCGM_Viper_O_jtac_Hex_Soldier",    \
    "TCGM_Viper_O_jtac_GHex_Soldier",   \
    "TCGM_Viper_O_jtac_UHex_Soldier",   \
    "TCGM_F_Diver_B",   \
    "TCGM_F_Diver_B_T", \
    "TCGM_F_Diver_O",   \
    "TCGM_F_Diver_O_T", \
    ...
    "TCGM_F_Diver_I_TL",    \
    "TCGM_F_Diver_B_Exp",   \
    "TCGM_F_Diver_B_T_Exp", \
    "TCGM_F_Diver_O_Exp",   \
    "TCGM_F_Diver_O_T_Exp", \
    "TCGM_F_Diver_I_Exp",   \
    "TCGM_F_DiverShort_B",  \
    "TCGM_F_DiverShort_B_T",    \
    "TCGM_F_DiverShort_O",  \
    "TCGM_F_DiverShort_O_T",    \
    "TCGM_F_DiverShort_I",  \
    "TCGM_F_Diver_Blu_C",   \
    "TCGM_F_Soldier_GEN_B", \
    "TCGM_F_Soldier1_LAT_I",    \
    "TCGM_F_Soldier2_I",    \
    "TCGM_F_Paramedic_C",   \
    "TCGM_F_Soldier02_I",   \
    "TCGM_F_Soldier02_RollUp_I",    \
    "TCGM_F_Soldier02_RollUp_lite_I",   \
    "TCGM_F_Soldier02_RollUp_A_I",  \
    "TCGM_F_Soldier02_RollUp_AR_I", \
    "TCGM_F_Soldier02_RollUp_SL_I", \
    "TCGM_F_Soldier02_RollUp_AA_I", \
    "TCGM_F_Soldier02_RollUp_medic_I",  \
    "TCGM_F_Soldier02_RollUp_repair_I", \
    "TCGM_F_Soldier02_RollUp_exp_I",    \
    "N19_D77HTCI_OCimport_01",  \
    "N19_D77HTCI_A_OCimport_01",    \
    "19_M808S_OCimport_01", \
    "19_M12_APC_Medical_OCimport_01",   \
    "DMNS_Shortsword_01_wreck_F",   \
    "Land_OPTRE_barrel_hydrogen",   \
    "Land_OPTRE_fusion_coil",   \
    "OPTRE_M12_CIV",    \
    "OPTRE_HEV",    \
    "OPTRE_Pelican_F",  \
    "OPTRE_Objects_Wreck_Pelican",  \
    "OPTRE_RCHog",  \
    "OPTRE_Sabre_Wreck_F",  \
    "unscdrone_wreck_F",    \
    ...
    "MEU_Sentinel_E",   \
    "OPTRE_FC_Spirit_F",    \
    "1stMEU_pelican_armed", \
    "1stMEU_pelican_armed_mg",  \
    "1stMEU_pelican_armed_single_seat", \
    "1stMEU_pelican_armed_mg_single_seat",  \
    "1stMEU_pelican_unarmed",   \
    "1stMEU_pelican_unarmed_mg",    \
    "1stMEU_pelican_unarmed_single_seat",   \
    "1stMEU_pelican_unarmed_mg_single_seat"
